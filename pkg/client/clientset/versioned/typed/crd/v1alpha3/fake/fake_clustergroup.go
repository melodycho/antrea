...
func (c *FakeClusterGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha3.ClusterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(clustergroupsResource, name), &v1alpha3.ClusterGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha3.ClusterGroup), err
}
...
func (c *FakeClusterGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha3.ClusterGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(clustergroupsResource, clustergroupsKind, opts), &v1alpha3.ClusterGroupList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha3.ClusterGroupList{ListMeta: obj.(*v1alpha3.ClusterGroupList).ListMeta}
	for _, item := range obj.(*v1alpha3.ClusterGroupList).Items {
...
func (c *FakeClusterGroups) Create(ctx context.Context, clusterGroup *v1alpha3.ClusterGroup, opts v1.CreateOptions) (result *v1alpha3.ClusterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(clustergroupsResource, clusterGroup), &v1alpha3.ClusterGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha3.ClusterGroup), err
...
func (c *FakeClusterGroups) Update(ctx context.Context, clusterGroup *v1alpha3.ClusterGroup, opts v1.UpdateOptions) (result *v1alpha3.ClusterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(clustergroupsResource, clusterGroup), &v1alpha3.ClusterGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha3.ClusterGroup), err
...
func (c *FakeClusterGroups) UpdateStatus(ctx context.Context, clusterGroup *v1alpha3.ClusterGroup, opts v1.UpdateOptions) (*v1alpha3.ClusterGroup, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(clustergroupsResource, "status", clusterGroup), &v1alpha3.ClusterGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha3.ClusterGroup), err
...
func (c *FakeClusterGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(clustergroupsResource, name), &v1alpha3.ClusterGroup{})
	return err
}
...
func (c *FakeClusterGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha3.ClusterGroupList{})
	return err
}
...
func (c *FakeClusterGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.ClusterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(clustergroupsResource, name, pt, data, subresources...), &v1alpha3.ClusterGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha3.ClusterGroup), err
