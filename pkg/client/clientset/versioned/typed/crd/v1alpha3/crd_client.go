...
func NewForConfig(c *rest.Config) (*CrdV1alpha3Client, error) {
	...
	return &CrdV1alpha3Client{client}, nil
}

// NewForConfigOrDie creates a new CrdV1alpha3Client for the given config and
...
func New(c rest.Interface) *CrdV1alpha3Client {
	return &CrdV1alpha3Client{c}
}
