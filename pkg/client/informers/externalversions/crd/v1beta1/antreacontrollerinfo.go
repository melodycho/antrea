	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdV1beta1().AntreaControllerInfos().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdV1beta1().AntreaControllerInfos().Watch(context.TODO(), options)
			},
		},
...
func (f *antreaControllerInfoInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdv1beta1.AntreaControllerInfo{}, f.defaultInformer)
}
